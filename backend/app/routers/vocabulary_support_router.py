...
from app.services.vocabulary_support_service import VocabularySupportService
from app.schemas.vocabulary_support_schema import VocabularyEntry, VocabularyResponse, VocabularyUpdateRequest
